...
import com.yaobing.module_middleware.BaseConstant;
import com.yaobing.module_middleware.R;
import com.yaobing.module_middleware.Utils.LogUtil;
import com.yaobing.module_middleware.Utils.UriUtil;
import com.yaobing.module_middleware.js.BridgeHandler;
import com.yaobing.module_middleware.js.BridgeWebView;
import com.yaobing.module_middleware.js.CallBackFunction;
import com.yaobing.module_middleware.js.DefaultHandler;
...
/**
 * Created by yaobing on 2018/12/20
...
//                function.onCallBack("接收到js调用onReload方法");
                ToastUtils.showShort( "登陆已失效，请重新登陆！");
